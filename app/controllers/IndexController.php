...
class IndexController extends BaseController{
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("user_name","email","phone","unique_id","date","package_name","referal_id","role","photo","password","account_status"); //registration fields
			...
			$modeldata['unique_id'] = random_num(5);
$modeldata['date'] = date_now();
$modeldata['referal_id'] = random_str(7);
